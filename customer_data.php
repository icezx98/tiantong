...
<div class="row">
  ...
  <ul class="pager">
    ...
    <li><a href="market_customer.php">ข้อมูลลูกค้าไม้ตลาด</a></li>
  </ul>
</nav>
<nav>
  ...
  <div class="clearfix visible-xs hidden-md hidden-lg">
        ...
        <section class="login">
  <div class="titulo"><pre>       ข้อมูลลูกค้า   </pre></div>
  <form >
    <ul class="nav nav-pills nav-stacked">
      <li role="presentation"><a href="company.php"><FONT COLOR='#23527c'><h3>ข้อมูลบริษัท</h3></FONT></a></li>
      <li role="presentation"><a href="market_customer.php"><FONT COLOR='#23527c'><h3>ข้อมูลลูกค้าไม้ตลาด</h3></FONT></a></li>
      </ul>
