...
<div class="row">
  ...
  <a href="customer_data.php">ข้อมูลลูกค้า</a>
   / 
    <a href="company.php">ข้อมูลบริษัท</a>
     
  </div>
  <div class="col-md-3">
  
  <ul class="blue">
<li><a class="current" title="home" href="insert/company_formin.php"><i class="glyphicon glyphicon-plus"></i>เพิ่มข้อมูล</a></li>
</ul>
  </div>
</div>
<hr width="80%">
...
<table id="example">
 ...
 <th width="150"><pre>รหัสบริษัท</pre></th>
 <th width="300"><pre>  ชื่อบริษัท  </pre></th>
 <th width="200"><pre>  ชื่อผู้ติดต่อ  </pre></th>
 <th width="400"><pre>         ที่อยู่         </pre></th>
 <th width="150"><pre>เบอร์โทรศัพท์</pre></th>
...
<?php
 ...
 echo "<td class='td'><a href='update/company_formupdate.php?id=".$data[0]."'><span data-hint='แก้ไข' class='hint-bottom-t-info'><span class='glyphicon glyphicon-edit' placeholder='Edit'></span></span></a>&nbsp;&nbsp;&nbsp;";
 echo "<a class='delete' href='delete/company_delete.php?id=".$data[0]."'><span data-hint='ลบ' class='hint-bottom-t-error'><span class='glyphicon glyphicon-trash'></span></span></a></td>";
     echo "<td>$data[0]</td>";
...
$(function() {
        ...
        $('a.delete').click(function(e) {
            ...
            var url = 'delete/company_delete.php';
            var values = {};
