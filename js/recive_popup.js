angular.module("recive_select_popup",['ngAnimate','ui.bootstrap'])
.controller("recive_select_popup_controller",["$scope","$http","$location","$uibModalInstance","items",function($scope,$http,$locationm,$uibModalInstance,items){
$scope.result = items;
$scope.disable = true;
