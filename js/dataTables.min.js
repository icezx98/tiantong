	...
	var S = function(g) {
		...
		function pb(a) {
			var b = a.oClasses,
				...
				e = a.oPreviousSearch,
				f = a.aanFeatures,
				h = '<input type="search" style="font: 14pt AngsanaUPC" class="' + b.sFilterInput + '"/>',
				i = d.sSearch,
		...
		function Jb(a, b) {
			...
			for (var f, h = m.ext.type.order[c.sType + "-pre"], i = 0, g = a.aoData.length; i < g; i++)
				if (c = a.aoData[i], c._aSortData || (c._aSortData =
		...
		m.defaults = {
			...
			oLanguage: {
				...
				sDecimal: "",
				sThousands: ",",
				sLengthMenu: "<font  Size='4' color='FFFFFF'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; จำนวนข้อมูลที่เเสดง :</font> _MENU_",
				sLoadingRecords: "Loading...",
				sProcessing: "Processing...",
				sSearch: "<font  Size='4' color='FFFFFF'><i class='glyphicon glyphicon-search'></i> ค้นหา :</font>",
				sSearchPlaceholder: "",
				sUrl: "",
...
(function(l, q) {
	var d = function(b, c) {
		b.extend(!0, c.defaults, {
			dom: "<'row'<'col-sm-4'l><'col-sm-7'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-4'i><'col-sm-7'p>>",
			renderer: "bootstrap"
		});
