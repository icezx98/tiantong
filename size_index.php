...
<div class="row">
  ...
  <ul class="blue">
<li><a class="current" title="home" href="insert/size_formin.php"><i class="glyphicon glyphicon-plus"></i>เพิ่มข้อมูล</a></li>
</ul>
  </div>
</div>
<hr width="80%">
...
<table >
 ...
 <!-- <th width="60">No.</th> -->
 <th width="150">รหัสขนาด</th>
 <th width="150">ชื่อขนาด</th>
...
<?php
 ...
 $data = mysql_fetch_array($result);
  ...
  echo "<td class='td'><a href='update/size_formupdate.php?id=".$data[0]."'><span data-hint='แก้ไข' class='hint-bottom-t-info'><span class='glyphicon glyphicon-edit' placeholder='Edit'></span></span></a>&nbsp;&nbsp;&nbsp;";
  echo "<a class='delete' href='delete/size_delete.php?id=".$data[0]."'><span data-hint='ลบ' class='hint-bottom-t-error'><span class='glyphicon glyphicon-trash'></span></span></a></td>";
...
$(function() {
        ...
        $('a.delete').click(function(e) {
            ...
            var url = 'delete/size_delete.php';
            var values = {};
