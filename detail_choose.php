...
<div class="row">
  ...
  /
    ...
    /
    <?php
      echo "<a href=\"detail_choose.php?choose_id=$choose_id\">รายละเอียดการคัดแยกสินค้า</a>"; 
    ?>
  </div>
  <div class="col-md-3">
...
<table>
 ...
 <tr>
  ...
  <th width="200"><pre>รหัสรายละเอียดการคัดแยกสินค้า</pre></th>
  <th width="500"><pre>รหัสการคัดแยกสินค้า</pre></th>
  ...
  <th width="200"><pre>จำนวนที่รับ</pre></th>
  <th width="200"><pre>จำนวนที่ใช้ได้</pre></th>
  <th width="200"><pre>จำนวนที่คัดออก</pre></th>
  <th width="200"><pre>ราคารวม/สินค้า(บาท)</pre></th>
 </tr>
 </thead>
<?php
 $sql = "select distinct detail_choose.detail_choose_id, detail_choose.choose_id, product.product_name, color.color_name, size.size_name, detail_choose.price_unit, detail_choose.amount_recive, detail_choose.amount_good, detail_choose.amount_remove, detail_choose.total_price_product
         from choose, detail_choose, product, detail_product, product_garden, color, size
         ...
         and detail_product.size_id = size.size_id";
...
$non = 0;
 ...
 echo "<td class='td'><a href='update/detail_choose_formupdate.php?detail_choose_id=".$data[0]."&choose_id=".$choose_id."'><span data-hint='แก้ไข' class='hint-bottom-t-info'><span class='glyphicon glyphicon-edit' placeholder='Edit'></span></span></a>  ";
