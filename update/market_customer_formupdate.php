...
<div class="row">
  ...
  <div class="col-md-7" style="font-size:2em;">
   ...
   /
    <a href="../market_customer.php">ข้อมูลลูกค้าไม้ตลาด(แก้ไขข้อมูล)</a>
...
$sql = "select * from market_customer where market_customer_id = '".$_GET["id"]."'" ;
 $result = mysql_query($sql);
 $num_rows = mysql_num_rows($result);
 $num_fields = mysql_num_fields($result);
 $i = 0;
 $market_customer_id="";
 $market_customer_name="";
 $market_customer_tel="";

 while($i<$num_rows){
 $data = mysql_fetch_array($result);
 $market_customer_id=$data[0];
 $market_customer_name=$data[1];
 $market_customer_tel=$data[2];
...
?>
  ...
  <div class="clearfix hidden-xs">
    <form method="post" action="market_customer_update.php">
<table >
  <tr >
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="market_customer_name" style="width:200px" value="<?php echo$market_customer_name;?>">
</div>
  </td>
    </tr>
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" onKeyUp="if(this.value*1!=this.value) this.value='' ;" maxlength=10 class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="market_customer_tel" style="width:200px" value="<?php echo$market_customer_tel;?>">
</div>
  </td>
    </tr>
  ...
  <div class="col-xs-8 col-md-6"><input type="submit" value="แก้ไข" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='../market_customer.php'"></td></div>
</div></td>
  </tr>
  </table>
</form>
...
<table style="width:90%">
  ...
  <td >
    <div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="market_customer_name" style="width:230px" value="<?php echo$market_customer_name;?>">
  </div></div>
  </td>
    </tr>
  ...
  <td style="width:200px">
    <div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" onKeyUp="if(this.value*1!=this.value) this.value='' ;" maxlength=10 class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="market_customer_tel" style="width:230px" value="<?php echo$market_customer_tel;?>">
  </div></div>
  </td>
    </tr>
  ...
  <tr>
  <td>
  <center><input type="submit" value="แก้ไข" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='../market_customer.php'"></td></center>
  </td>
  </tr>
  </table>
</form>
