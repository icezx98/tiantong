...
<div class="row">
  ...
  / 
  <a href="employee.php">ข้อมูลพนักงาน(แก้ไขข้อมูล)</a>
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="employee_name"  style="width:200px" value="<?php echo$employee_name;?>">
</div>
  </td>
    </tr>
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" onKeyUp="if(this.value*1!=this.value) this.value='' ;" maxlength=10 text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="employee_tel"  style="width:200px" value="<?php echo$employee_tel;?>">
</div>
  </td>
    </tr>
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="user_manage"  style="width:200px" value="<?php echo$user_manage;?>">
</div>
  </td>
    </tr>
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" text-align="center" class="form-control"  placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" readonly="readonly" name="username"  style="width:200px" value="<?php echo$username;?>">
</div>
  </td>
    </tr>
...
<div class="input-group">
  ...
  <tr>
  <td style="width:200px"><div class="col-md-9 col-md-push-2">

  <a class="btn btn-default" href='resetpass.php?id=<?php echo$employee_id;?>'><h4>รีเซ็ตรหัสผ่าน</h4></a></div></td>

  <td><div class="row">
  <div class="col-xs-10 col-sm-4 col-md-6"></div>
  <div class="col-xs-8 col-md-6"><input type="submit" value="แก้ไข" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='employee.php'"></td></div>
</div></td>
  </tr>
  </table>
  </center>
...
<div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="employee_name"  style="width:230px" value="<?php echo$employee_name;?>">
</div></div>
  </td>
    </tr>
...
<div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" onKeyUp="if(this.value*1!=this.value) this.value='' ;" maxlength=10 text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="employee_tel"  style="width:230px" value="<?php echo$employee_tel;?>">
</div></div>
  </td>
    </tr>
...
<div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="user_manage"  style="width:230px" value="<?php echo$user_manage;?>">
</div></div>
  </td>
    </tr>
...
<div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" text-align="center" class="form-control"  placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" readonly="readonly" name="username"  style="width:230px" value="<?php echo$username;?>">
</div></div>
  </td>
    </tr>
...
<div class="input-group">
  ...
  <td>
    ...
    <a class="btn btn-default" href='resetpass.php?id=<?php echo$employee_id;?>'><h4>รีเซ็ตรหัสผ่าน</h4></a><br>
     <center><input type="submit" value="แก้ไข" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='employee.php'"></td></center>
</td>
  </tr>
  </table>
  </center>
...
$(function() {
        ...
        $('a.btn.btn-default').click(function(e) {
            ...
            swal({
                ...
                text: "รหัสผ่านจะถูกเปลี่ยนเป็นค่าเริ่มต้น!",
                type: "warning",
             ...
             $.ajax(
                {
                    ...
                    success : function(data, textStatus, jqXHR)
                    {
                        ...
                        if(data.message == 'success') {
                            ...
                            swal({title: "รีเซ็ตเรียบร้อย",   text: "คุณทำการรีเซ็ตรหัสผ่านเรียบร้อยแล้ว!",  /* timer: 1000, */  showConfirmButton: true });
