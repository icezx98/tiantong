...
<div class="row">
  ...
  <div class="col-md-7" style="font-size:2em;">
   ...
   <!-- /
	 ...
	 /
    <a href="../recive.php">รับสินค้า(แก้ไขข้อมูล)</a>
...
<?php
 ...
 $sql = "select * from recive where recive_id = '".$_GET["id"]."'" ;
...
?>
  ...
  <div class="clearfix hidden-xs">
    <form method="post" action="recive_update.php">
<table >
  <tr >
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="date" name="dateInput" ng-model="orderDate" ng-change="changOrderDate()" oninvalid="setCustomValidity('กรุณาเลือกวันที่')" oninput="setCustomValidity('')" value = "<?php echo $recive_date; ?>" required>
</div>
  </td>
    </tr>
...
<tr>
  ...
  <td>
          <select class="form-control" name="garden_id" style="width:227px" >
    <?php
       // $sql = "select company_id,company_name from company where company_id = '".$company_id."'  ";  
       $sql = "select garden_network_id,garden_network_name from garden_network where 
                garden_network_id ='".$garden_network_id."' ";
       $result = mysql_query($sql);
       $num_rows = mysql_num_rows($result);
       $num_fields = mysql_num_fields($result);
       $i = 0;
      ...
      $sql = "select garden_network_id,garden_network_name from garden_network where 
       ...
       $num_fields = mysql_num_fields($result);
       $i = 0;
      //  if($garden_network_id != ""){echo "<option value=''>เลือกสวน</option>";
      // };
...
<!-- <tr >
  ...
  <td style="width:200px"> 
      <div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" class="form-control" placeholder="กรอกข้อมูล"  aria-describedby="sizing-addon2" name="total_price" style="width:200px" value="<?php echo $total_price;?>">
</div>
</td>
</tr> -->
...
<div class="row">
  ...
  <div class="col-xs-8 col-md-6"><input type="submit" value="แก้ไข" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='../recive.php'"></td></div>
</div>
