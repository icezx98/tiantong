...
<div class="row">
  ...
  <div class="col-md-3">
	...
	<ul class="blue">
<li><a class="current" title="home" href="garden_network_formin.php"><i class="glyphicon glyphicon-plus"></i>เพิ่มข้อมูล</a></li>
</ul>
  </div>
</div>
<hr width="80%">
...
<table id="example">
 ...
 <th width="300"><pre>รหัสสวนเครือข่าย</pre></th>
 <th width="250"><pre>   ชื่อสวน  </pre></th>
 <th width="250"><pre>ชื่อผู้ติดต่อ</pre></th>
 <th width="400"><pre>    ที่อยู่    </pre></th>
 <th width="200"><pre>เบอร์โทร</pre></th>
 


 </tr></thead>
<?php
 $sql = "select * from garden_network order by garden_network_name asc";
 ...
 echo "<td class='td'><a href='garden_network_formupdate.php?id=".$data[0]."'><span data-hint='แก้ไข' class='hint-bottom-t-info'><span class='glyphicon glyphicon-edit' placeholder='Edit'></span></span></a>&nbsp;&nbsp;&nbsp;";
 echo "<a class='delete' href='garden_network_delete.php?id=".$data[0]."'><span data-hint='ลบ' class='hint-bottom-t-error'><span class='glyphicon glyphicon-trash'></span></span></a></td>";
     echo "<td>$data[0]</td>";
...
$(function() {
        ...
        $('a.delete').click(function(e) {
            ...
            var url = 'garden_network_delete.php';
            var values = {};
