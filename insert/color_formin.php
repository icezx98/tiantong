...
<div class="row">
  ...
  <div class="col-md-7" style="font-size:2em;">
   ...
   /
	  <a href="../index.php">ข้อมูลหลัก</a>
	 /
    <a href="../color_index.php">ข้อมูลสี(เพิ่มข้อมูล)</a>
...
<?php
 ...
 $test_id = "select MAX(SUBSTRING(color_id,2)) as num FROM color";
...
?>
  <div class="clearfix visible-xs hidden-md hidden-lg" >
    <form method="post" action="color_in.php">
<table style="width:90%">
  ...
  <input type="text" class="form-control" placeholder="กรอกข้อมูล"  aria-describedby="sizing-addon2" name="color_id" readonly="readonly" style="width:230px" value="<?php echo $color_id;?>">
</div></div>
</td>
</tr>
  ...
  <td > 
      <div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="color_name" style="width:230px" oninvalid="setCustomValidity('กรุณากรอกข้อมูล')" oninput="setCustomValidity('')" required >
</div></div>
  </td>
    </tr>
  ...
  <center><input type="submit" value="เพิ่ม" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='../color_index.php'"></td></center>
...
<table >
  ...
  <input type="text" class="form-control" placeholder="กรอกข้อมูล"  aria-describedby="sizing-addon2" name="color_id" readonly="readonly" style="width:200px" value="<?php echo $color_id;?>">
</div>
</td>
</tr>
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2"></span>
  <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="color_name" style="width:200px" oninvalid="setCustomValidity('กรุณากรอกข้อมูล')" oninput="setCustomValidity('')" required >
</div>
  </td>
    </tr>
...
<div class="row">
  ...
  <div class="col-xs-1 col-md-7"><input type="submit" value="เพิ่ม" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='../color_index.php'"></td></div>
</div>
