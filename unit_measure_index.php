...
<div class="row">
  ...
  <a href="master_data.php">ข้อมูลหลัก</a>
   /
    <a href="unit_measure_index.php">ข้อมูลหน่วยนับ</a>
    
  </div>
  <div class="col-md-3">
  
  <ul class="blue">
<li><a class="current" title="home" href="unit_measure.php"><i class="glyphicon glyphicon-plus"></i>เพิ่มข้อมูล</a></li>
</ul>
  </div>
</div>
<hr width="80%">
...
<table>
 ...
 <!-- <th width="60">No.</th> -->
 <th width="150">รหัสหน่วยนับ</th>
 <th width="150">ชื่อหน่วยนับ</th>


 </tr>
<?php
 $sql = "select * from unit_measure order by unit_measure_name asc";
 ...
 $data = mysql_fetch_array($result);
  ...
  echo "<td class='td'><a href='unit_measure_formupdate.php?id=".$data[0]."'><span data-hint='แก้ไข' class='hint-bottom-t-info'><span class='glyphicon glyphicon-edit' placeholder='Edit'></span></span></a>&nbsp;&nbsp;&nbsp;";
  echo "<a class='delete' href='unit_measure_delete.php?id=".$data[0]."'><span data-hint='ลบ' class='hint-bottom-t-error'><span class='glyphicon glyphicon-trash'></span></span></a></td>";
...
$(function() {
        ...
        $('a.delete').click(function(e) {
            ...
            var url = 'unit_measure_delete.php';
            var values = {};
