angular.module('product', [])
  .controller('productController', ['$scope','$http',function($scope,$http) {
    ...
    $scope.test= 'ffff'
    function getProduct(){
    	$http.get('../product_select.php').success(function(data){
    		$scope.product=data
    		getParameterFromUrl()
    	})
    }
    $scope.getColor = function (change){
    	...
    	$http.get('../product_color.php?productName='+$scope.product[$scope.productSelect][0]).success(function(data){
    		$scope.color=data
    ...
    $scope.getSize = function (change){
    	...
    	$http.get('../product_size.php?productName='+$scope.product[$scope.productSelect][0]+"&colorId="+$scope.color[$scope.colorSelect][0]).success(function(data){
    		$scope.size=data
    ...
    $scope.getUnit = function (change){
    	...
    	$http.get('../product_unit.php?productName='+$scope.product[$scope.productSelect][0]+"&colorId="+$scope.color[$scope.colorSelect][0]+"&sizeId="+$scope.size[$scope.sizeSelect][0]).success(function(data){
    		$scope.unit=data
