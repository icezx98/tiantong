...
<div class="row">
  ...
  <!-- /
	<a href="master_data.php">ข้อมูลหลัก</a> -->
	 / 
    <a href="choose_garden.php">สวนทางเลือก</a>
    
  </div>
  <div class="col-md-3">
	
	 <ul class="blue">
<!-- <li><a class="current" title="home" href="./insert/choose_formin.php"><i class="glyphicon glyphicon-plus"></i>เพิ่มข้อมูล</a></li> -->
</ul>
  </div>
</div>
<hr width="80%">
...
<thead>
 ...
 <th width="50"><pre>รหัสการคัดแยกเกรด</pre></th>
 <th width="100"><pre>รหัสการรับสินค้า</pre></th>
 <th width="150"><pre>วันที่คัดแยกเกรด</pre></th>
 <th width="80"><pre>ราคารวม</pre></th>
...
<?php
 $sql = "select choose.choose_id, choose.recive_id, choose.choose_date, choose.total_price, employee.employee_name
         from choose, employee
         where choose.employee_id = employee.employee_id";
 ...
 echo "<td class='td'><a href='detail_choose.php?choose_id=".$data[0]."'><span data-hint='รายการ' class='hint-bottom-t-info'><span class='glyphicon glyphicon-list-alt' placeholder='Edit'></span></span></a>";
