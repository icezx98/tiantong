...
<div class="row">
  ...
  <a href="../product_data.php">ข้อมูลสินค้า</a>
   / 
    <a href="../product.php">สินค้า(เพิ่มข้อมูล)</a>
...
<?php
 ...
 $test_id = "select MAX(SUBSTRING(product_id,4)) as num FROM product";
 ...
 if($rows){
  $num = $rows['num'];
    ...
    $test_id = $num+1;
    if($test_id < 10){
     $produce_id = "P000".$test_id;

        }
      elseif ($test_id < 100) {
        $produce_id = "P00".$test_id;
      }
      elseif ($test_id < 1000) {
        $produce_id = "P0".$test_id;
      }
      elseif ($test_id < 10000) {
        $produce_id = "P".$test_id;
      }
...
<table >
  <tr >
    <td style="width:20px"><div class="col-md-9 col-md-push-5">รหัสสินค้า</div><div class="col-md-1 col-md-push-1"><b>&nbsp;&nbsp;&nbsp;&nbsp;*</b></div></td>
    <td style="width:200px"> 
        <div class="input-group">
          <span class="input-group-addon" id="sizing-addon2"></span>
          <input type="text" class="form-control" placeholder="กรอกข้อมูล"  aria-describedby="sizing-addon2" name="product_id" readonly="readonly" style="width:200px" value="<?php echo $produce_id;?>">
        </div>
  </td>
</tr>
  ...
  <tr>
      ...
      <td style="width:200px">
        <div class="input-group">
          <span class="input-group-addon" id="sizing-addon2"></span>
          <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="product_name" style="width:200px" oninvalid="setCustomValidity('กรุณากรอกข้อมูล')" oninput="setCustomValidity('')" required>
        </div>
      </td>
 </tr>
...
<div class="row">
  ...
  <div class="col-xs-1 col-md-7"><input type="submit" value="เพิ่ม" style="width:80px">&nbsp;<input type="reset" value="ยกเลิก" style="width:80px" ONCLICK="window.location.href='../product.php'"></td></div>
</div>
  ...
  <tr >
    <td > 
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="กรอกข้อมูล"  aria-describedby="sizing-addon2" name="product_id" readonly="readonly" style="width:230px" value="<?php echo $produce_id;?>">
          </div>
        </div>
  </td>
</tr>
  ...
  <tr>
      <td >
        <div class="input-group">
          ...
          <div class="col-md-9 col-md-push-5">
          <input type="text" text-align="center" class="form-control" placeholder="กรอกข้อมูล" aria-describedby="sizing-addon2" name="product_name" style="width:230px" oninvalid="setCustomValidity('กรุณากรอกข้อมูล')" oninput="setCustomValidity('')" required>
          </div>
        </div>
      </td>
 </tr>
